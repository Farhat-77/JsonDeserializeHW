...
namespace JsonDeserializeHW
{
    ...
    class Program
    {
        ...
        {
            Request tom = new Request { type = "Astana", query = "Astana, Kazakhstan", language = "en", unit = "m" };
            string json = JsonSerializer.Serialize<Request>(tom);
            Console.WriteLine(json);
            Request restoredRequest = JsonSerializer.Deserialize<Request>(json);
            Console.WriteLine(restoredRequest.type);
        }
    }
}
